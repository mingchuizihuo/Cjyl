...
<script src="${domainUrl}/assets/js/TotalModule/dataManage/checkInStartCost.js"></script>
        ...
        <div class="bs-example">
            <table class="table table-striped table-bordered" id="oldTable">
                ...
                <tr>
                    ...
                    <td>1200</td>
                    <td>300</td>
                    <td><input type="button" class="button" value="修改" onclick="checkInStartUrl()"></td>
                </tr>
                </tbody>
            </table>
        </div>
...
<#--增删改查按钮-->
    <div class="modify">
        <button class="pull-left btn-style btn-ma" onclick="checkInStartUrl(1)" ><img src="${domainUrl}/assets/images/backstage/jia.png">增加</button>
