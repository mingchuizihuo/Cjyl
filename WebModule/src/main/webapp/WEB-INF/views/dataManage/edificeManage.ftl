...
<script src="${domainUrl}/assets/js/TotalModule/dataManage/edificeManage.js"></script>
        ...
        <div class="bs-example">
            <table class="table table-striped table-bordered" id="oldTable">
                ...
                <tr>
                    ...
                    <td>一号楼</td>
                    <td>行政楼</td>
                    <td><input type="button" class="button" value="修改"  onclick="edificeUrl()"></td>
                </tr>
                </tbody>
            </table>
        </div>
...
<#--增删改查按钮-->
    <div class="modify">
        <button class="pull-left btn-style btn-ma"   onclick="edificeUrl(1)" ><img src="${domainUrl}/assets/images/backstage/jia.png">增加</button>
